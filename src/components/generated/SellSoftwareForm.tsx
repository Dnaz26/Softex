...
export const SellSoftwareForm = ({
  ...
  return <>
      <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 overflow-y-auto" data-magicpath-id="0" data-magicpath-path="SellSoftwareForm.tsx">
        <div className="bg-[#0a0f1a] rounded-2xl w-full max-w-3xl border border-gray-800 my-8" data-magicpath-id="1" data-magicpath-path="SellSoftwareForm.tsx">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-5 border-b border-gray-800" data-magicpath-id="2" data-magicpath-path="SellSoftwareForm.tsx">
            <div data-magicpath-id="3" data-magicpath-path="SellSoftwareForm.tsx">
            ...
            <button onClick={onClose} className="w-10 h-10 flex items-center justify-center hover:bg-gray-800 rounded-lg transition-colors" data-magicpath-id="6" data-magicpath-path="SellSoftwareForm.tsx">
              <X className="w-5 h-5 text-white" data-magicpath-id="7" data-magicpath-path="SellSoftwareForm.tsx" />
            </button>
          </div>

          {/* Form */}
          <form onSubmit={handleSubmit} className="px-6 py-6" data-magicpath-id="8" data-magicpath-path="SellSoftwareForm.tsx">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5" data-magicpath-id="9" data-magicpath-path="SellSoftwareForm.tsx">
              {/* Business Name */}
              <div className="md:col-span-2" data-magicpath-id="10" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="13" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Category */}
              <div data-magicpath-id="16" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Location */}
              <div data-magicpath-id="27" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Annual Revenue */}
              <div data-magicpath-id="31" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="34" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Asking Price */}
              <div data-magicpath-id="37" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="40" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Email */}
              <div data-magicpath-id="43" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="46" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Phone */}
              <div data-magicpath-id="49" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="52" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Description */}
              <div className="md:col-span-2" data-magicpath-id="55" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="relative" data-magicpath-id="58" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              <div className="md:col-span-2" data-magicpath-id="61" data-magicpath-path="SellSoftwareForm.tsx">
              ...
              {/* Upload Documents */}
              <div className="md:col-span-2" data-magicpath-id="64" data-magicpath-path="SellSoftwareForm.tsx">
                ...
                <div className="border-2 border-dashed border-gray-700 rounded-xl px-6 py-8 text-center hover:border-[#4169E1] transition-colors cursor-pointer" data-magicpath-id="66" data-magicpath-path="SellSoftwareForm.tsx">
            ...
            {/* Submit Button */}
            <div className="flex gap-4 mt-6" data-magicpath-id="70" data-magicpath-path="SellSoftwareForm.tsx">
