...
export const SignupScreen = ({
  ...
  return <div className="fixed inset-0 bg-black z-50 flex items-center justify-center overflow-y-auto" data-magicpath-id="0" data-magicpath-path="SignupScreen.tsx">
      {/* Close Button */}
      <button onClick={onClose} className="fixed top-6 right-6 w-12 h-12 flex items-center justify-center hover:bg-gray-900 rounded-lg transition-colors z-10" data-magicpath-id="1" data-magicpath-path="SignupScreen.tsx">
      ...
      <div className="w-full max-w-[680px] px-6 py-16 my-8" data-magicpath-id="3" data-magicpath-path="SignupScreen.tsx">
        {/* Header - Moved "Create Account" inside visible area */}
        <div className="bg-[#1E3A8A] rounded-t-3xl px-12 py-10" data-magicpath-id="4" data-magicpath-path="SignupScreen.tsx">
        ...
        {/* Form */}
        <div className="bg-[#0a0f1a] rounded-b-3xl px-12 py-10" data-magicpath-id="7" data-magicpath-path="SignupScreen.tsx">
          <form onSubmit={handleSubmit} className="space-y-6" data-magicpath-id="8" data-magicpath-path="SignupScreen.tsx">
            {/* Profile Picture */}
            <div className="flex flex-col items-center mb-6" data-magicpath-id="9" data-magicpath-path="SignupScreen.tsx">
              <div className="relative" data-magicpath-id="10" data-magicpath-path="SignupScreen.tsx">
                <div className="w-32 h-32 bg-[#1E3A8A] rounded-full flex items-center justify-center overflow-hidden" data-magicpath-id="11" data-magicpath-path="SignupScreen.tsx">
                ...
                <button type="button" onClick={handleProfilePictureClick} className="absolute bottom-0 right-0 w-11 h-11 bg-[#1E3A8A] rounded-full flex items-center justify-center border-4 border-[#0a0f1a] hover:bg-[#1E40AF] transition-colors" data-magicpath-id="14" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* First Name */}
            <div data-magicpath-id="18" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="21" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Last Name */}
            <div data-magicpath-id="24" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="27" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Email */}
            <div data-magicpath-id="30" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="33" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Phone Number */}
            <div data-magicpath-id="36" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="39" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Password */}
            <div data-magicpath-id="42" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="45" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Retype Password */}
            <div data-magicpath-id="48" data-magicpath-path="SignupScreen.tsx">
              ...
              <div className="relative" data-magicpath-id="51" data-magicpath-path="SignupScreen.tsx">
            ...
            {/* Login Link */}
            <div className="text-center pt-4" data-magicpath-id="55" data-magicpath-path="SignupScreen.tsx">
